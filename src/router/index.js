...
const routes = [
  ...
  { path: '/dashboard/ocupacion', name: 'OcupacionDashboard', component: () => import('../views/Dashboard/Ocupacion.vue'), meta: { tituloPagina: 'Dashboard de Ocupación' } },
  { path: '/dashboard/heatmap', name: 'HeatmapDashboard', component: () => import('../views/Dashboard/Heatmap.vue'), meta: { tituloPagina: 'Mapa de Calor' } },
  ...
  { path: '/admin/categorias', name: 'CategoriasAdmin', component: () => import('../views/Admin/Categorias.vue'), meta: { tituloPagina: 'Gestión de Categorías' } },
